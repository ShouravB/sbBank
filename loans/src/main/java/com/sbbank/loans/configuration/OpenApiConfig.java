package com.sbbank.loans.configuration;
...
//        prodServer.setDescription("Server URL in Production environment");
        ...
        Info info = new Info()
                .title("sbBank Loans Service")
                .version("1.0")
                .contact(contact)
                .description("This API exposes endpoints to manage Loan services of sbBank.")
                .termsOfService("shouravbhattarai.info")
                .license(myLicense);
